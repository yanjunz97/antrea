...
func (ap *ipfixAggregationProcess) ResetExternalFieldsFilled(record *ipfixintermediate.AggregationFlowRecord) {
	ap.AggregationProcess.SetExternalFieldsFilled(record, false)
}
